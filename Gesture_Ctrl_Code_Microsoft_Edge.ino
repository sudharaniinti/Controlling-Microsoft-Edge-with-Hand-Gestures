const int trigger1 = 2; //Trigger pin of 1st Sensor(1st means LEFT)
...
void loop() 
{
  ...
  if ((distance_L>30 && distance_R>30) && (distance_L<50 && distance_R<50))
  {
    Serial.println("Open");
    delay (500);
  }
  
  if ((distance_L<20 && distance_R<20) && (distance_L>5 && distance_R>5))
  {
  ...
  calculate_distance(trigger1,echo1);
  distance_L=dist;calculate_distance(trigger2,echo2);
  distance_R=dist;
